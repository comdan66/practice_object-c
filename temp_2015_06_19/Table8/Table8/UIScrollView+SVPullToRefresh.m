...
- (void)setLastUpdatedDate:(NSDate *)newLastUpdatedDate {
    ...
    self.dateLabel.text = [NSString stringWithFormat:@"Last Updated: %@", newLastUpdatedDate?[self.dateFormatter stringFromDate:newLastUpdatedDate]:@"Never"];
}

- (void)setDateFormatter:(NSDateFormatter *)newDateFormatter {
	dateFormatter = newDateFormatter;
    self.dateLabel.text = [NSString stringWithFormat:@"Last Updated: %@", self.lastUpdatedDate?[newDateFormatter stringFromDate:self.lastUpdatedDate]:@"Never"];
}
