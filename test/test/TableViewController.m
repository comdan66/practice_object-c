...
//    cell.textLabel.text = @"das";
    ...
    [cell.nextButton addTarget:self action:@selector(customMethod:) forControlEvents:UIControlEventTouchUpInside];
    
    return cell;
}
- (void)customMethod:(MyTableViewCell *)cell {
    [self performSegueWithIdentifier:@"xxx" sender:cell];
}
