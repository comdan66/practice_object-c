...
@implementation IndexTableViewCell2
...
- (void) initCreatedLabel {
    ...
    [self.createdLabel setFont:[IndexTableViewCell2 createdLabelFont]];
...
- (void) initDescriptionLabel {
    ...
    [self.descriptionLabel setFont:[IndexTableViewCell2 descriptionLabelFont]];
    [self.descriptionLabel setTextColor:[UIColor colorWithRed:0.31 green:0.31 blue:0.31 alpha:1]];
    
    NSMutableParagraphStyle *paragraphStyle = [[NSMutableParagraphStyle alloc] init];
    [paragraphStyle setLineSpacing:[IndexTableViewCell2 descriptionLabelLineSpacing]];
    ...
    [attributedString addAttribute:NSKernAttributeName
                             value:@([IndexTableViewCell2 descriptionLabelSpacing])
...
- (void)initCommentButtonButton {
    ...
    [self.commentButton.titleLabel setFont:[IndexTableViewCell2 commentButtonFont]];
...
- (void)initLikeButton {
    ...
    [self.likeButton.titleLabel setFont:[IndexTableViewCell2 likeButtonFont]];
