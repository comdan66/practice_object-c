...
#import "IndexTableViewCellOri.h"

@implementation IndexTableViewCellOri
...
- (IndexTableViewCellOri *)initBaseData {
    ...
    [self.likeButton.titleLabel setFont:[IndexTableViewCellOri likeButtonFont]];
    ...
    [self.commentButton.titleLabel setFont:[IndexTableViewCellOri commentButtonFont]];
    
    [self.nameLabel setFont:[IndexTableViewCellOri nameLabelFont]];
    [self.nameLabel setTextColor:[UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:1]];
    
    [self.createdLabel setFont:[IndexTableViewCellOri createdLabelFont]];
    ...
    [self.descriptionLabel setFont:[IndexTableViewCellOri descriptionLabelFont]];
    [self.descriptionLabel setTextColor:[UIColor colorWithRed:0.31 green:0.31 blue:0.31 alpha:1]];
    
    NSMutableParagraphStyle *paragraphStyle = [[NSMutableParagraphStyle alloc] init];
    [paragraphStyle setLineSpacing:[IndexTableViewCellOri descriptionLabelLineSpacing]];
    ...
    [attributedString addAttribute:NSKernAttributeName
                             value:@([IndexTableViewCellOri descriptionLabelSpacing])
...
- (IndexTableViewCellOri *)initUI:(id)picture w:(float)w{
